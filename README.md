...
4. Create PostgreSQL at [neon.tech](https://neon.tech), copy `DATABASE_URL`
...
*[Link to demo video — record with Loom or OBS showing: login → create survey → fill form → view analytics]*
